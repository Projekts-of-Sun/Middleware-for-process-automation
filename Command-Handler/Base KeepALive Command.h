...
namespace CommandHandler
{
	...
	class CBaseKeepAliveCommand: public CBaseCommand
	{
		public:
			...
			virtual bool operator ==(const CBaseKeepAliveCommand& P) const;

			CBaseKeepAliveCommand();
			virtual ~CBaseKeepAliveCommand();
